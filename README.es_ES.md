...
Este proyecto es un fork de [MHSanaei/3x-ui](https://github.com/MHSanaei/3x-ui). Un agradecimiento especial a:

- [MHSanaei](https://github.com/MHSanaei) — Creador y mantenedor original de 3X-UI
- [alireza0](https://github.com/alireza0/) — Contribuidor principal del proyecto original
