...
Этот проект является форком [MHSanaei/3x-ui](https://github.com/MHSanaei/3x-ui). Особая благодарность:

- [MHSanaei](https://github.com/MHSanaei) — Оригинальный создатель и мейнтейнер 3X-UI
- [alireza0](https://github.com/alireza0/) — Основной участник оригинального проекта
